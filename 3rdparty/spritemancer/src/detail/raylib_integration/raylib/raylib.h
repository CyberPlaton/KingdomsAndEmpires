...
typedef enum {
    ...
    FLAG_WINDOW_FOCUSED     = 0x00000800,   // Set to window focused
...
RLAPI void ShutdownWindow(void);                                     // Close window and unload OpenGL context
...
RLAPI void SetShaderValueMatrixEx(Shader shader, int locIndex, float mat[16]);      // Set shader uniform value (matrix 4x4)
