...
namespace core
{
	...
	//------------------------------------------------------------------------------------------------------------------------
	void cuuid::save(TArchiveOut& archive) const
	{
		archive(m_data, m_string, m_hash);
	}

	//------------------------------------------------------------------------------------------------------------------------
	void cuuid::load(TArchiveIn& archive)
	{
		archive(m_data, m_string, m_hash);
	}
...
#include <errno.h>
	...
	//------------------------------------------------------------------------------------------------------------------------
	void scolor::save(TArchiveOut& archive) const
	{
		archive(m_r, m_g, m_b, m_a);
	}

	//------------------------------------------------------------------------------------------------------------------------
	void scolor::load(TArchiveIn& archive)
	{
		archive(m_r, m_g, m_b, m_a);
	}
	...
	//------------------------------------------------------------------------------------------------------------------------
	void srect::save(TArchiveOut& archive) const
	{
		archive(m_x, m_y, m_w, m_h);
	}

	//------------------------------------------------------------------------------------------------------------------------
	void srect::load(TArchiveIn& archive)
	{
		archive(m_x, m_y, m_w, m_h);
	}
	...
	//------------------------------------------------------------------------------------------------------------------------
	void cpath::save(TArchiveOut& archive) const
	{
		archive(m_string_path);
	}

	//------------------------------------------------------------------------------------------------------------------------
	void cpath::load(TArchiveIn& archive)
	{
		string_t path;
		archive(path);
